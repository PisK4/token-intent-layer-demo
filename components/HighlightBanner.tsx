...
const HIGHLIGHTS: Highlight[] = [
  ...
  },
  {
    icon: Zap,
    accent: "#A855F7",
    title: "OFT Rebalancing · 不经过 Solver 网络",
  ...
  },
  {
    ...
    accent: "#F59E0B",
    title: "Non-EVM 一等公民",
    body: "Solana / Aptos / Sui 经 Wormhole 桥接直通 EVM Vault；Solana USDC 通过 CCTP 原生直达；jitoSOL / mSOL 打开 SOL 第三核心终态。",
  },
  {
    icon: RotateCcw,
    accent: "#F97316",
    title: "Source-only · 源链闭环（无 Solver 补位）",
